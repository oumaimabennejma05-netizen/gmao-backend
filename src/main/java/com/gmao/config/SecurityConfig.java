...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow any origin — the frontend may be accessed via localhost, LAN IP, or cloud domain.
        // In production, replace with explicit origins via an environment variable.
